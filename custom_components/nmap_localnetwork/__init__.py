"""
Custom integration to integrate NMap data with Home Assistant nmap_localintegration.

For more details about this integration, please refer to
https://github.com/jarikai/nmap_localintegration
"""
...
from .data import NMapLocalNetworkData
...
async def async_setup_entry(
    ...
    entry.runtime_data = NMapLocalNetworkData(
